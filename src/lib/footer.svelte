...
<footer class="bg-white">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul class="text-gray-500  font-medium">
                      <li class="mb-4">
                          <a href={platforms[2].download_url} class="hover:underline">Windows</a>
                      </li>
                      <li class="mb-4">
                          <a href={platforms[1].download_url} class="hover:underline">Mac Intel</a>
                      </li>
                      <li>
                        <a href={platforms[0].download_url} class="hover:underline">Mac Silicon</a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul class="text-gray-500 font-medium">
                      <li class="mb-4">
                          <a href="https://github.com/akademiaapp/" class="hover:underline ">Github</a>
                      </li>
                      <!-- <li>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center ">© {new Date().getFullYear()} <a href="https://akademia.cc/" class="hover:underline">Akademia™</a>. All Rights Reserved.
          </span>
          <div class="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <a href="https://github.com/akademiaapp/" class="text-gray-500 hover:text-gray-900 ms-5">
