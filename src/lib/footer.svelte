		...
		<div class="md:flex md:justify-between">
			<div class="mb-6 md:mb-0">
				...
				<p class="opacity-50 max-w-[32rem] pt-4">
					...
					undervisere arbejder og samarbejder på, og fremmer produktivitet, kreativitet og læring på
					tværs af alle niveauer af uddannelser.
				</p>
			</div>
			<div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
				<div>
					...
					<ul class="text-gray-500 font-medium">
						<li class="mb-4">
							<a href={platforms[2].download_url} class="fancy">Windows</a>
						</li>
						<li class="mb-4">
							<a href={platforms[1].download_url} class="fancy">Mac Intel</a>
						</li>
						<li>
							<a href={platforms[0].download_url} class="fancy">Mac Silicon</a>
						</li>
					</ul>
				</div>
				<div>
